        ...
        <ScrollArea className="h-full px-6">
          {suggestions.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center p-6">
              ...
              <p className="text-muted-foreground">No AI recommendations yet</p>
              <p className="text-sm text-muted-foreground mt-2">Use the app to receive personalized suggestions</p>
            </div>
          ) : (
